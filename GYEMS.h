...
public:
    ...
    void ReadReply12bit(byte commandByte, int8_t replyData[4]);
    void ReadReply13bit(byte commandByte, int16_t replyData[4]);
    void ReadReply14bit(byte commandByte, int64_t replyData[1]);
    void ReadPIDParameter(int8_t replyData[6]);
    void WritePIDParameter(int8_t anglePidKp, int8_t anglePidki, int8_t speedPidKp, int8_t speedPidKi, int8_t iqPidKp, int8_t iqPidKi);
    void SetZero(void);
    void ReadMuitiLoopAngle(int64_t replyData[4]);
    void MotorOff(void);
    void MotorStop(void);
    void MotorRun(void);
    void TorqueOpenControl(int16_t Torque, int16_t replyData[4], bool reply_flag);
    ...
    void MultiPositionControlMode1(int64_t Deg, int16_t replyData[1], bool reply_flag);
    void MultiPositionControlMode2(int64_t Deg, uint32_t DPS, int16_t replyData[1], bool reply_flag);
